...
class TestConfirmationDialog:
    ...
    @patch("src.terminal.menu.print_animated")
    @patch("builtins.print")
    def test_confirmation_dialog_invalid_then_valid(
        self, mock_print_builtin, mock_print_animated, mock_input
    ):
...
class TestInputDialog:
    ...
    @patch("src.terminal.menu.print_animated")
    @patch("builtins.print")
    def test_input_dialog_with_validation(
        self, mock_print_builtin, mock_print_animated, mock_input
    ):
    ...
    @patch("src.terminal.menu.print_animated")
    @patch("builtins.print")
    def test_input_dialog_validation_retry(
        self, mock_print_builtin, mock_print_animated, mock_input
    ):
    ...
    @patch("src.terminal.menu.print_animated")
    @patch("builtins.print")
    def test_input_dialog_keyboard_interrupt(
        self, mock_print_builtin, mock_print_animated, mock_input
    ):
