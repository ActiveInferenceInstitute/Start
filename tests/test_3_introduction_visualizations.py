...
"""
        ...
        )  # Three headers (# Main Title, ## Section 1, ## Learning Objectives)
...
class TestMermaidDiagramGeneration:
    ...
    def test_create_curriculum_flow_mermaid(self):
        ...
        sections = ["Introduction", "Core Concepts", "Mathematical Framework", "Applications"]
    ...
    def test_create_curriculum_structure_mermaid(self):
        ...
        curricula_data = [
            {"entity_name": "Data Scientist", "sections": ["Intro", "Core", "Advanced"]},
            {
...
"""
        ...
        assert (
            entity1_data["section_count"] == 3
        )  # Three headers (# Entity1 Curriculum, ## Introduction, ## Learning Objectives)
...
"""
    ...
    @patch("visualizations.common_setup_logging")
    def test_main_no_curriculum_files(self, mock_logging, tmp_path):
    ...
    @patch("visualizations.common_setup_logging")
    def test_main_data_collection_error(self, mock_logging, mock_collect_data, tmp_path):
