...
def test_collect_curriculum_files_with_files(tmp_path):
    ...
    entity1_dir.mkdir()
    (entity1_dir / "complete_curriculum_20240101_120000.md").write_text("Entity 1 curriculum", encoding="utf-8")
    
    entity2_dir = tmp_path / "entity2"
    entity2_dir.mkdir()
    (entity2_dir / "complete_curriculum_20240102_130000.md").write_text("Entity 2 curriculum", encoding="utf-8")
...
def test_collect_curriculum_files_nested_structure(tmp_path):
    ...
    (deep_dir / "complete_curriculum_20240103_140000.md").write_text("Deep curriculum", encoding="utf-8")
...
def test_generate_curriculum_metrics_basic():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        assert list(df.columns) == [
            'Entity', 'Total Words', 'Sections', 'Paragraphs',
            'Words per Section', 'Words per Paragraph'
        ]
...
def test_run_function_with_files(tmp_path, monkeypatch):
    ...
    curriculum_file.write_text("# Test Curriculum\n\nTest content\n\n## Section 1\nSection content", encoding="utf-8")
