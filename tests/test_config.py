...
def test_save_and_load_yaml_config(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(src.common.config, "data_root", data_root_override)
...
def test_yaml_config_must_be_a_mapping(tmp_path, monkeypatch):
    def data_root_override():
        return tmp_path
    ...
    (config_dir / "list.yaml").write_text("- invalid\n", encoding="utf-8")

    with pytest.raises(ValueError, match="mapping"):
        load_yaml_config("list")
