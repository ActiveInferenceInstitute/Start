...
class TestScriptIntegration:
    ...
    def test_client_configurations(self):
        ...
        from src.perplexity.clients import OpenRouterConfig, PerplexityConfig
...
def test_error_handling_patterns():
    ...
    for script_name in scripts:
        ...
        ), f"Script {script_name} missing proper exception handling"
...
if __name__ == "__main__":
    ...
    test_methods = [
        method_name for method_name in dir(test_class) if method_name.startswith("test_")
    ]
    ...
    standalone_tests = [test_script_documentation, test_error_handling_patterns]
