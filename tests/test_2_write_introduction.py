...
spec = importlib.util.spec_from_file_location(
    "write_introduction", 
    os.path.join(os.path.dirname(__file__), '..', 'learning', 'curriculum_creation', '2_Write_Introduction.py')
)
...
class TestIntegration:
    ...
    def test_realistic_workflow(self, tmp_path):
        ...
        fep_file.write_text("""# Free Energy Principle and Active Inference
