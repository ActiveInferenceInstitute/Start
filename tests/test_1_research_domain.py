...
spec = importlib.util.spec_from_file_location(
    "research_domain",
    os.path.join(
        os.path.dirname(__file__), "..", "learning", "curriculum_creation", "1_Research_Domain.py"
    ),
)
...
class TestMainFunction:
    ...
    @patch("research_domain.common_setup_logging")
    @patch("research_domain.build_perplexity_client")
    def test_main_client_initialization_error(self, mock_build_client, mock_logging, tmp_path):
