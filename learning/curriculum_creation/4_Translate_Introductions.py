...
from src.common.paths import data_written_curriculums_dir, data_translated_curriculums_dir
...
def validate_languages(requested_languages: List[str], available_languages: List[str]) -> List[str]:
    ...
    for lang in requested_languages:
        ...
        if lang in available_languages:
            ...
            print(f"Note: Translation quality may vary for custom languages.")
            valid_languages.append(lang)
...
def main():
    ...
    parser.add_argument("--output", 
                       help="Path to save translated files (default: data/translated_curriculums)")
    ...
    try:
        ...
        try:
            success_count, failed_count = process_translations(client, str(input_dir), str(output_dir), target_languages)
        except Exception as e:
