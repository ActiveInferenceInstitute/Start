...
def clone_repository(url: str, destination: Path, branch: Optional[str] = None, shallow: bool = False) -> Path:
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Clone a GitHub repository with optional branch and shallow options")
